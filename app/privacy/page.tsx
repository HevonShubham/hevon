    ...
    <main className="min-h-screen bg-[#fff8f2] px-6 py-20 text-[#111]">
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-6 text-base leading-8 text-black/60">
          ...
          <p>The optional protein calculator may collect age band, gender, body weight, the resulting educational protein estimate and an email address when you choose to save the result. It does not diagnose a condition or replace advice from a qualified health professional.</p>

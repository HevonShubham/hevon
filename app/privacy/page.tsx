    ...
    <main className="min-h-screen bg-[#fff8f2] px-6 py-20 text-[#111]">
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-6 text-base leading-8 text-black/60">
          <p>HEVON collects the contact details, state, city, optional PIN code, age band, diet, coffee preferences, expected purchase frequency, price comfort and purchase intent you voluntarily submit through the early-access form. We use this information to understand demand, prioritize launch markets and send consented product-development, tasting and launch updates.</p>
